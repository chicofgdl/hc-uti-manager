...
# Prefer explicit POSTGRES_DSN for migrations when present (useful for CI / production).
# Fall back to SQLITE_DSN / SQLITE_PATH or a default local SQLite file for local development.
